...
class MapGenerator:
    ...
    def generate_walls(self, scene):
        ...
        wall_cfg.func(ceiling_path, wall_cfg.replace(size=(scene.env_spacing * 1.5, scene.env_spacing * 1.5, 0.1)), translation=(0.0, 0.0, 3.0))
    ...
    def generate_occupancy_map(self, scene):
        ...
        occ_generator.set_transform(
            (0, 0, 0), 
            (-scene.env_spacing / 2.0 - 2, -scene.env_spacing / 2.0 - 2, 0.1), # 0.1m above ground
