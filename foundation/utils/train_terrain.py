...
import time
import os
# from .any2usd import load_pcd_as_points
...
class MapGenerator:
    ...
    def generate_walls(self, scene, terrain_length, terrain_width, cols, rows, ceiling_height):
        """
        ...
        ceiling_cfg.func(ceiling_path, ceiling_cfg, translation=(terrain_length * cols / 2.0, terrain_width * rows / 2.0, ceiling_height))
    ...
    def create_environment(self, scene, terrain: TerrainImporterCfg, **kwargs):
        ...
        ceiling_height = kwargs.get("ceiling_height", 2.0)
        walls = self.generate_walls(scene, terrain_length, terrain_width, cols, rows, ceiling_height)
        ...
        #     "/World/PCDPoints",
        #     pcd_path,
        #     point_size=math.sqrt(3) * 0.05,
        #     resolution=0.05,
        #     translate=(0.0, 0.0, 0.0),
        #     use_height_color=True,
        #     colormap='rainbow'
        # )
        load_pcd_as_points(stage=stage,
                           prim_path="/World/PCDPoints",
                           pcd_path=pcd_path,
                           point_size=math.sqrt(3) * 0.05,
                           use_height_color=True,
                           colormap='turbo')
