...
class QuadcopterEnvCfg(DirectRLEnvCfg):
    ...
    terrain_path = "./USD/sparse/sparse"
    grid_path = "./RASTER/sparse"
    ...
    # controller_Kang = [20.0, 30.0, 20.0]  # Roll and pitch angle controller gains   #15 15 20
    ...
    # Kp = [20.0, 20.0, 20.0]  # Position controller proportional gains
    # Kd = [0.0, 0.0, 0.0]  # Position controller derivative gains
...
class QuadcopterEnv(DirectRLEnv):
    ...
    def __init__(self, cfg: QuadcopterEnvCfg, render_mode: str | None = None, **kwargs):
        ...
        self._maps = []
        self.first_reach_stamp = torch.full((self.num_envs,), torch.inf, device=self.device)
    ...
    def _get_dones(self) -> tuple[torch.Tensor, torch.Tensor]:
        ...
        # distance_to_goal = torch.norm(self._robot.data.root_state_w[:, :3] - self._desired_pos_w, dim=1)
        # reach_mask = distance_to_goal < self.cfg.success_radius
        # leave_mask = ~reach_mask
        # self.first_reach_stamp = torch.where(
        #     reach_mask & torch.isinf(self.first_reach_stamp),
        #     self.episode_length_buf,
        #     self.first_reach_stamp,
        # )
        # self.first_reach_stamp = torch.where(
        #     leave_mask,
        #     torch.full_like(self.first_reach_stamp, torch.inf),
        #     self.first_reach_stamp,
        # )
