...
class QuadcopterEnv(DirectRLEnv):
    ...
    def _get_observations(self) -> dict:
        ...
        obs_actor = self.CHECK_NAN(obs_actor, "Actor Observation")
        obs_critic = self.CHECK_NAN(obs_critic, "Critic Observation")

        return {"policy": obs_actor, "critic": obs_critic, "rnd_state": obs_actor}
