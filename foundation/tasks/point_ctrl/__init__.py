...
gym.register(
    id="distill_post",
    entry_point=f"{__name__}.distill_post_env:QuadcopterEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.distill_post_env:QuadcopterEnvCfg",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:QuadcopterDistillPostRunnerCfg",
    },
)