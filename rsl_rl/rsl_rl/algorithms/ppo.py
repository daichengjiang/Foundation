...
class PPO:
    ...
    def update(self):  # noqa: C901
        ...
        for (
                ...
                with torch.inference_mode():
                    ...
                    if self.gpu_global_rank == 0:
                        if kl_mean > self.desired_kl * 2.0:
                            ...
                            self.learning_rate = min(2e-4, self.learning_rate * 1.5)
            ...
            mean_critic_value += value_batch.mean().item()
            max_value_loss += torch.max((value_batch - returns_batch).pow(2)).item()
            # -- RND loss
        ...
        mean_critic_value /= num_updates
        mean_max_value_loss = max_value_loss / num_updates
        # -- For RND
        if mean_rnd_loss is not None:
        ...
        loss_dict = {
            ...
            "return": mean_return,
            "critic_value": mean_critic_value,
            "max_value_loss": mean_max_value_loss,
        }
        if self.rnd:
